...
# u em outras palavras, a complexidade de tempo será a quantidade de elementos que está em s.
...
# e as variáveis primeira_nota e segunda_nota que recebem o método nota_indidual que possui
# Complexidade de Tempo é O(len(s) + len(t)), que prevalece
